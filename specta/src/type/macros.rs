...
macro_rules! _impl_ndt {
    ...
    (
        ...
        impl_ndt!(@as
            ...
            [$head :: $( $tail )::+]
            [< $first_impl_generic, $second_impl_generic, $third_impl_generic, $( $const_generic ),* >]
            $( where { $($bounds)* } )?
            as $as_ty
        );
        impl_ndt!($($rest)*);
    ...
    (
        ...
        impl_ndt!(@as
            ...
            [$head :: $( $tail )::+]
            [< $first_impl_generic, $second_impl_generic, $( $const_generic ),* >]
            $( where { $($bounds)* } )?
            as $as_ty
        );
        impl_ndt!($($rest)*);
    ...
    (
        ...
        impl_ndt!(@as
            ...
            [$head :: $( $tail )::+]
            [< $first_impl_generic, $( $const_generic, )* $( $rest_impl_generic ),* >]
            $( where { $($bounds)* } )?
            as $as_ty
        );
        impl_ndt!($($rest)*);
    ...
    (
        ...
        impl_ndt!(@as
            [$( const $const_generic : $const_ty, )* $( $rest_impl_generic, )*]
            [$head :: $( $tail )::+]
            [< $( $const_generic, )* $( $rest_impl_generic ),* >]
            $( where { $($bounds)* } )?
            as $as_ty
        );
        impl_ndt!($($rest)*);
