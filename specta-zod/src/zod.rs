...
fn map_datatype_format(exporter: &Zod, types: &Types, dt: &DataType) -> Result<DataType, Error> {
...
fn map_datatype_fields(exporter: &Zod, types: &Types, fields: &mut Fields) -> Result<(), Error> {
    match fields {
        Fields::Unit => {}
