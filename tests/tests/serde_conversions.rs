...
fn format_unifies_aliases() {
    ...
    let all_hidden_fields = Typescript::default()
        .export(
            &Types::default().register::<AllHiddenFieldAlias>(),
            specta_serde::Format,
        )
        .expect("an all-hidden aliased struct should retain its empty object shape");
    ...
    assert_eq!(
        all_hidden_fields,
        "// This file has been generated by Specta. Do not edit this file manually.\nexport type AllHiddenFieldAlias = Record<string, never>;\n"
    );
