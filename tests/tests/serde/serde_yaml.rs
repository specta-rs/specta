...
fn serde_yaml() {
    ...
    insta::assert_snapshot!(assert_ts_inline2::<serde_yaml::Mapping>().unwrap(), @"Partial<{ [key in YamlValue]: YamlValue }>");
    insta::assert_snapshot!(assert_ts_inline2::<serde_yaml::value::TaggedValue>().unwrap(), @"{ [key in string]: YamlValue }");
