...
In the multi-file layout, cross-module imports are guarded by `TYPE_CHECKING` to
keep mutually recursive modules importable; the output is intended for static
type checking rather than runtime evaluation of cross-module alias values.
