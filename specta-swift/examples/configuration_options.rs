...
fn main() {
    ...
    let default_output = default_swift.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let header_output = custom_header.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let pascal_output = pascal_case.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let camel_output = camel_case.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let snake_output = snake_case.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let spaces_output = spaces_4.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let spaces2_output = spaces_2.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let tabs_output = tabs.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let protocol_output = protocol_generics
        .export(&types, specta_swift::raw_format())
        .unwrap();
    ...
    let question_output = question_mark.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let optional_output = optional_type.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let protocols_output = with_protocols.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let serde_output = with_serde.export(&types, specta_swift::raw_format()).unwrap();
    ...
    let combined_output = combined.export(&types, specta_swift::raw_format()).unwrap();
