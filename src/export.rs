...
pub fn ts_with_cfg(path: &str, cfg: &ExportConfiguration) -> Result<(), TsExportError> {
    let mut out = "// This file has been generated by Specta. DO NOT EDIT.\n\n".to_string();

    let export_by_default = cfg.export_by_default.unwrap_or(true);
    ...
    let types = types
        ...
        .filter_map(|v| match v {
            ...
            DataType::Enum(CustomDataType::Named(NamedCustomDataType { name, export, .. })) => {
                export.unwrap_or(export_by_default).then(|| (name, v))
            }
