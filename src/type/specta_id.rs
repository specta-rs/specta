...
// TODO: Can this be an `as_str` and no allocate? because really we know the length required.
impl ToString for SpectaID {
    fn to_string(&self) -> String {
        format!("{}-{}", self.type_name, self.hash)
    }
}
...
/// A Rust module path.
///
/// Eg. `specta::internal::NamedDataType` or `uuid::Uuid`
#[derive(Debug, Clone, Copy, PartialEq, Eq, PartialOrd, Ord)]
pub struct ModulePath(pub(crate) &'static str);
