...
pub enum TsExportError {
    ...
    #[error("Attempted to export '{0}' but was unable to due to variant name '{0}' conflicting with a reserved keyword in Typescript. Try renaming it or using `#[specta(rename = \"new name\")]`")]
    ForbiddenVariantName(ExportPath, &'static str),
